...
class _ColoreYMas extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Padding(
  ...
  Widget build(BuildContext context) {
    return FadeInLeft(
      ...
      child: GestureDetector(
        onTap: () {
          final zapatoModal = Provider.of<ZapatoModel>(context, listen: false);
          zapatoModal.assetImage = image;
        },
        child: Container(
          width: 45,
          height: 45,
